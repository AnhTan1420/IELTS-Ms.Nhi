...
- ĐỘ BAO QUÁT BẮT BUỘC: quét bài theo từng câu, đối chiếu với checklist sau cho MỖI câu: (1) chính tả, (2) thì và hòa hợp chủ-vị, (3) mạo từ (a/an/the/không mạo từ), (4) giới từ, (5) danh từ đếm được/không đếm được + số ít/số nhiều, (6) dấu câu, (7) từ loại (word form: adj/noun/verb/adv dùng sai chỗ), (8) collocation sai hoàn toàn. Một bài luận band 6-7 dài ~250-300 từ trở lên GẦN NHƯ LUÔN có ít nhất 8-15 lỗi thuộc các nhóm trên. Nếu sau khi quét bạn tìm được ít hơn con số đó, PHẢI quét lại toàn bộ bài thêm một lần nữa theo đúng checklist trước khi chốt "corrections" — không được kết luận sớm rằng bài "ít lỗi" nếu chưa quét đủ kỹ theo từng mục trên.`;
...
- **Nhận xét tổng quan:** [MỘT đoạn 1-2 câu, PHẢI CÁ NHÂN HÓA, nhắc tên chủ đề bài viết, nêu rõ nhóm lỗi/điểm yếu ở trên đang trực tiếp "giam chân" tiêu chí nào. Đây LUÔN LÀ 1 BULLET RIÊNG BIỆT với nhãn "**Nhận xét tổng quan:**" — TUYỆT ĐỐI KHÔNG được viết nối tiếp vào bullet "Điểm sáng" phía trên, phải xuống dòng và bắt đầu bằng "- **Nhận xét tổng quan:**".]
